...
import homeImg from "../../../assets/texno.jpg"

export default function BasAyna({handleClose, handleOpen , open}) {
  return (
    <div className="bas-ayna border border-gray-700 p-2 md:p-5 rounded-lg row-span-1 col-span-2 col-start-1 row-start-1 md:col-span-1 md:col-start-1">
        <p>Bas ayna</p>
        <div className="flex gap-3">
          ...
          <div className='basis-[50%] p-5 relative'>
            <img src={homeImg} alt=""  className='w-full h-full object-cover rounded-lg '/>
          </div>
        </div>
      </div> 
